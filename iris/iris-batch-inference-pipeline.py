...
if LOCAL == False:
   stub = modal.Stub()
   hopsworks_image = modal.Image.debian_slim().pip_install(["hopsworks","joblib","seaborn","sklearn==1.1.1","dataframe_image"])
...
def g():
    ...
    iris_fg = fs.get_feature_group(name="iris", version=2)
    df = iris_fg.read() 
    #print(df)
